...
<head>
    ...
    <style type="text/css">
        .loginCode{width:150px; height:48px; background:url(/Public/Admin/images/loginpassword.png) no-repeat; border:none;line-height:48px; padding-left:44px; font-size:14px; color:#90a2bc;}
    </style>
</head>
        ...
        <div class="loginbody">
            ...
            <div class="loginbox">
                <ul>
                    ...
                    <li>
                        <input name="code" type="text" class="loginCode" placeholder="验证码" />
...
<script>
    $('img').click(function(){
        var src = "/Admin/Index/verify/"+Math.random();
        $(this).attr('src',src)
    })
</script>
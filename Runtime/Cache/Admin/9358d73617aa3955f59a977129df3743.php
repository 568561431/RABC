...
<body>
    ...
    <div class="mainindex">
        <div class="welinfo">
            ...
            <b><?php echo (session('username')); ?></b>(admin@uimaker.com)
            <a href="#">帐号设置</a>
        </div>
        <div class="welinfo">
            <span><img src="/Public/Admin/images/time.png" alt="时间" /></span>
            <i><?php echo (date('Y-m-d H:i:s',$manager_info["manager_login"])); ?></i>
        </div>
        <div class="xline"></div>
        <div class="box"></div>
        <div class="welinfo">
        ...
        <ul class="infolist">
            <li><span>服务器类型：</span><?php echo ($_SERVER['SERVER_SOFTWARE']); ?></li>

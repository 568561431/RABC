            ...
            <ul class="forminfo">
                ...
                <li>
                    ...
                    <select name="auth_pid" class="dfinput">
                        ...
                        <?php if(is_array($auth_list)): foreach($auth_list as $key=>$vo): ?><option value="<?php echo ($vo["auth_id"]); ?>"><?php echo ($vo["auth_name"]); ?></option><?php endforeach; endif; ?>
                    </select>
                    <i></i></li>
                <li>
                    <label>控制器名</label>
                ...
                <li>
                	<label>是否显示</label>
                	<cite>
                		<input name="auth_show" type="radio" value="1" checked="checked" />显示
                		&nbsp;&nbsp;&nbsp;&nbsp;
                		<input name="auth_show" type="radio" value="0" />不显示</cite>
                </li>
                <li>
                    <label>&nbsp;</label>

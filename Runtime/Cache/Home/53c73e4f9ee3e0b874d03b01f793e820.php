			...
			<div class="goodslist mt10">
				<ul>
					<?php if(is_array($goods_list)): foreach($goods_list as $key=>$vo): ?><li>
						<dl>
							<dt><a href="<?php echo U('detail','goods_id='.$vo[goods_id]);?>"><img src="<?php echo (ltrim($vo["goods_logo"],'.')); ?>" alt="" /></a></dt>
							<dd><a href="<?php echo U('detail','goods_id='.$vo[goods_id]);?>"><?php echo ($vo["goods_name"]); ?></a></dt>
							<dd><strong><?php echo ($vo["goods_price"]); ?></strong></dt>

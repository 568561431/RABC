		...
		<div class="content fl ml10">
			...
			<div class="order_bd mt10">
				<table class="orders">
					...
					<tbody>
					<?php if(is_array($order_list)): foreach($order_list as $key=>$vo): ?><tr>
							<td><a href=""><?php echo ($vo["order_number"]); ?></a></td>
							<td><a href="">
								<?php if(is_array($og_goodslogo)): foreach($og_goodslogo as $key=>$v): ?><img src="<?php echo (ltrim($v,'.')); ?>" alt="" /><?php endforeach; endif; ?>
							</a></td>
							<td><?php echo ($vo["mem_name"]); ?></td>
							<td>￥<?php echo ($vo["order_price"]); ?> 货到付款</td>

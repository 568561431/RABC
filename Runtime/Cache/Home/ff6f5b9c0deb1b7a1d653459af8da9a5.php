...
<div class="header w1210 bc mt15">
	...
	<link rel="stylesheet" href="/Public/Home/Cart/css/cart.css" type="text/css">
	...
	<div class="buy_blank" id="cartBox" style="display:none;z-index:99;">
		<h4>
			<span><a href="javascript:;" onclick="hideElement('cartBox')"><img src="/Public/Home/Cart/images/close.jpg" title="点击关闭"/></a></span>
			该商品已成功添加到购物车
		</h4>
		...
		<p>
			<a href="<?php echo U('Cart/flow');?>" onclick="javascript:hideElement('cartBox')" class="bt_orange" target="_black"></a>
			<a href="javascript:hideElement('cartBox')" class="bt_blue"></a>
		</p>
	</div>
	<!-- 头部 end-->
	<meta name="keywords" content="" />
	<mrta name="description" content="" />
	<div style="clear:both;"></div>
	...
	<div class="main w1210 mt10 bc">
		...
		<div class="breadcrumb">
			<h2>当前位置：<a href="">首页</a> > <a href="">电脑、办公</a> > <a href=""><?php echo ($cate_info["0"]["cate_name"]); ?></a> ><?php echo ($goods_info["goods_name"]); ?></h2>
		</div>
		<!-- 面包屑导航 end -->
		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?php echo (ltrim($pic_list["0"]["pic_big"],'.')); ?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?php echo (ltrim($pic_list["0"]["pic_mid"],'.')); ?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<?php if(is_array($pic_list)): foreach($pic_list as $key=>$vo): if($key == 0 ): ?><li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo (ltrim($vo["pic_mid"],'.')); ?>',largeimage: '<?php echo (ltrim($vo["pic_big"],'.')); ?>'}"><img src="<?php echo (ltrim($vo["pic_sma"],'.')); ?>"></a>
								</li>
								<?php else: ?>
									<li>
										<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?php echo (ltrim($vo["pic_mid"],'.')); ?>',largeimage: '<?php echo (ltrim($vo["pic_big"],'.')); ?>'}"><img src="<?php echo (ltrim($vo["pic_sma"],'.')); ?>"></a>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li><span>上架时间：</span><?php echo (date('Y-m-d',$goods_info["goods_saletime"])); ?></li>
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有21人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
					<form action="" method="post" class="choose">
						<ul>
							<?php if(is_array($attr_list)): foreach($attr_list as $key=>$vo): ?><li class="product">
								<dl>
									<dt><?php echo ($vo["attr_name"]); ?>：</dt>
									<dd>
										<?php if(is_array($vo["ga_vals"])): foreach($vo["ga_vals"] as $key=>$v): if($key == 0 ): ?><a class="selected" href="javascript:;"><?php echo ($v); ?>
											<input type="radio" name="<?php echo ($vo["attr_name"]); ?>" value="<?php echo ($v); ?>" checked="checked" /></a>
											<input type="hidden" name="" value="" />
											<?php else: ?>
											<a href="javascript:;"><?php echo ($v); ?>
											<input type="radio" name="<?php echo ($vo["attr_name"]); ?>" value="<?php echo ($v); ?>" /></a>
											<input type="hidden" name="" value="" /><?php endif; endforeach; endif; ?>
									</dd>
								</dl>
							...
							<li>
								<dl>
									<dt>&nbsp;</dt>
									<dd>
										<input type="button" id="add_btn" data="<?php echo ($goods_info["goods_id"]); ?>" value="" class="add_btn" />
									</dd>
								</dl>
							</li>
			...
			<div class="detail">
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						<div class="attr mt15">
							<ul>
								<?php if(is_array($goods_attr)): foreach($goods_attr as $key=>$vo): ?><li><span><?php echo ($vo["attr_name"]); ?>：</span><?php echo ($vo["ga_vals"]); ?></li><?php endforeach; endif; ?>
							</ul>
						</div>
